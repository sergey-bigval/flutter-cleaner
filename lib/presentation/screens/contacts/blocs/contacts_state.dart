class ContactsState {
  final bool isAllContScanning;
  final int allContactsSize;

  final bool isDubEmailContScanning;
  final int dubEmailContactsSize;
  ...
  ContactsState({
    required this.isAllContScanning,
    required this.allContactsSize,

    required this.isDubEmailContScanning,
    required this.dubEmailContactsSize,
  });
  ...
  factory ContactsState.initial() => ContactsState(
    ...
    dubEmailContactsSize: 0,
  );

  ContactsState copyWith({
    bool? isAllContScanning,
    int? allContactsSize,
    bool? isDubEmailContScanning,
    int? dubEmailContactsSize,
  }) {
    return ContactsState(
      isAllContScanning: isAllContScanning ?? this.isAllContScanning,
      allContactsSize: allContactsSize ?? this.allContactsSize,
      isDubEmailContScanning: isDubEmailContScanning ?? this.isDubEmailContScanning,
      dubEmailContactsSize: dubEmailContactsSize ?? this.dubEmailContactsSize,
    );
  }
}
// class EmailsState {
